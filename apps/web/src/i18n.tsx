...
const EN_MESSAGES = {
  ...
  componentManagementHelp: "Modules can be nested to any depth. Platform identifies where a module runs; choosing a platform does not create a module.",
  newComponent: "New module",
  parentComponent: "Parent module",
  topLevelComponent: "Top-level module (no parent)",
  save: "Save",
  ...
  optionalDetailsHelp: "Platform, version, operating system, device, and source revision",
...
const ZH_MESSAGES: Record<MessageKey, string> = {
  ...
  componentManagementHelp: "模块支持多层父子关系。“所属平台”表示模块运行在哪一端，选择平台不会自动创建模块。",
  newComponent: "新增模块",
  parentComponent: "上级模块",
  topLevelComponent: "顶层模块（无上级）",
  save: "保存",
  ...
  optionalDetailsHelp: "平台、版本、系统、设备和代码版本",
  ...
  landsInInbox: "条目会先进入待整理；确认清楚后再转为待处理。",
  productName: "产品名称",
  itemPrefix: "条目前缀",
