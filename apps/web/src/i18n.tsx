...
const EN_MESSAGES = {
  ...
  productManagementHelp: "Products, components, and workspace settings",
  ...
  componentManagementHelp: "Components can be nested to any depth. Type is only a technical classification and does not create a component.",
  newComponent: "New component",
  parentComponent: "Parent component",
  topLevelComponent: "Top level (no parent)",
  save: "Save",
...
const ZH_MESSAGES: Record<MessageKey, string> = {
  ...
  manageProducts: "管理产品",
  productManagementHelp: "集中管理产品、组件和工作区配置",
  existingProducts: "已有产品",
  newProduct: "新增产品",
  productSettings: "产品设置",
  prefixLockedHelp: "已有条目编号依赖此前缀，因此暂不允许修改。",
  saveProduct: "保存产品",
  productComponents: "产品组件",
  manageComponents: "管理组件",
  noComponents: "暂时还没有组件。",
  componentManagementHelp: "组件支持多层父子关系。“组件类型”只是技术分类，选择类型不会自动创建组件。",
  newComponent: "新增组件",
  parentComponent: "上级组件",
  topLevelComponent: "顶层组件（无上级）",
  save: "保存",
