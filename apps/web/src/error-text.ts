 ...
 * slow down, server down, offline -- get a sentence of our own. Anything else
 * keeps the server's text, because it is usually a specific validation message
 * and a generic "something went wrong" would throw that detail away.
 */
