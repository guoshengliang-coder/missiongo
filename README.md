...
生产构建面向 Chrome/Edge 90+、Firefox 90+ 和 Safari/iOS 15.4+。低于 1024px 时切换为单栏布局，并适配安全区和底部手势区域（横屏适配尚不完整，见 [UI/UE 复盘](docs/ui-ue-review-2026-09.md) C1、C2）。离线能力仅覆盖应用壳层、已缓存页面和本地草稿，不缓存 API、管理员凭据或受保护附件，也不会在离线时排队提交。
